      ...
      nodes: [
        {
          ...
          type: "heading-one",
          data: { className: null },
          nodes: [{ object: "text", text: "Welcome to Internote!", marks: [] }]
        },
        {
          object: "block",
          type: "paragraph",
        ...
        },
        {
          ...
          nodes: [
            ...
            { object: "text", text: " Internote", marks: [] }
          ]
        },
        {
          object: "block",
        ...
        },
        {
          ...
          nodes: [
            ...
            { object: "text", text: " including ", marks: [] },
            {
              object: "text",
              text: "combinations ",
              marks: [
            ...
            { object: "text", text: " as well as lists, ", marks: [] },
            {
              object: "text",
              text: "code snippets",
          ...
          nodes: [
            {
              ...
              data: { className: null },
              nodes: [
                { object: "text", text: "Integrated code editor", marks: [] }
              ]
            },
            {
              object: "block",
          ...
          nodes: [
            {
              object: "text",
              text:
                "Internote automatically saves your notes in the cloud and is ",
              marks: []
            },
            {
              object: "text",
        ...
        },
        {
          ...
          data: { className: null },
          nodes: [
            { object: "text", text: "I built ", marks: [] },
            {
              object: "text",
              text: "Internote ",
              marks: [{ object: "mark", type: "bold", data: {} }]
